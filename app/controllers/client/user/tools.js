...
module.exports = {
  ...
  code: [
    { strategy: "isNotNull", message: codes.USER_CODE.ERROR_CODE_NOT_NULL },
  ],
  password: [
    {
      strategy: "isNotNull",
      message: codes.USER_CODE.ERROR_INIT_PASS_NOT_NULL,
    },
    { strategy: "minLenght:6", message: codes.USER_CODE.ERROR_MIN_LENGHT_SIX },
    {
      strategy: "maxLenght:16",
      message: codes.USER_CODE.ERROR_MAX_LENGHT_SIXTY,
    },
  ],
  repeatpwd: [
    {
      strategy: "isNotNull",
      message: codes.USER_CODE.ERROR_CONFIRM_PASS_NOT_NULL,
    },
  ],
};
